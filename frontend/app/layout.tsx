...
import { Activity, Stethoscope, LayoutDashboard, Settings, FileText, Network } from 'lucide-react';
import './globals.css';
  ...
  return (
    <aside className="w-64 shrink-0 bg-surface-1 border-r border-border flex flex-col shadow-xl">
      ...
      <nav className="flex-1 p-4 space-y-2">
        ...
        <NavLink href="/insights" icon={<Network className="w-5 h-5" />} label="Insights Graph" />
