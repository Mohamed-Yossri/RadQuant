"""DICOM processing tool (read, window/level, convert to PNG).

Derived verbatim from MedRAX `medrax/tools/dicom.py` (Apache-2.0).
See radcopilot/foundation/NOTICE.md for attribution.
"""
...
class DicomProcessorTool(BaseTool):
    ...
    def _run(
        ...
        """Process DICOM file and save as a viewable PNG."""
        try:
