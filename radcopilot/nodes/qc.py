...
from radcopilot.prompts.draft_report import _pretty
from radcopilot.prompts.synonyms import synonyms_for

Judge = Callable[[str], str]


def _default_judge(prompt: str) -> str:
    from radcopilot.models.medgemma import generate
